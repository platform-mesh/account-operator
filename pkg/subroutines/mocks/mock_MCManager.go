...
func (_mock *Manager) Engage(context1 context.Context, s multicluster.ClusterName, cluster1 cluster.Cluster) error {
...
func (_c *Manager_Engage_Call) Run(run func(context1 context.Context, s multicluster.ClusterName, cluster1 cluster.Cluster)) *Manager_Engage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *Manager_Engage_Call) RunAndReturn(run func(context1 context.Context, s multicluster.ClusterName, cluster1 cluster.Cluster) error) *Manager_Engage_Call {
	_c.Call.Return(run)
	return _c
}
