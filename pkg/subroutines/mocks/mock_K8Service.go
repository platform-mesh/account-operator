...
// template: testify
//
// MANUAL MODIFICATION: Added Apply method for controller-runtime v0.22.1 compatibility
// The Apply method was introduced in client.Writer interface and is required for client.Client
...
// MANUALLY ADDED: This method was added for controller-runtime v0.22.1 compatibility
// The Apply method was introduced in the Writer interface and is required for client.Client
